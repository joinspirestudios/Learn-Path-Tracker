...
export function makeDayLog(dayNumber, data = {}){
  ...
  return {
    ...
    pendingTaskIds: Array.isArray(data.pendingTaskIds) ? data.pendingTaskIds : [],
    optionalSkippedTaskIds: Array.isArray(data.optionalSkippedTaskIds) ? data.optionalSkippedTaskIds : [],
    taskReflections: data.taskReflections && typeof data.taskReflections === 'object' ? data.taskReflections : {},
    sessionStartedAt: data.sessionStartedAt || null,
    sessionLastActiveAt: data.sessionLastActiveAt || null,
