...
Supplied HTML screen samples may be used structurally only. Do not copy them as a palette source of truth, do not rename the product, and do not add fake metrics.
